...
namespace pmm
{
    ...
    struct Page {
        ...
        union {
            ...
            pmos::containers::DoubleListHead<Page>
                free_region_list; // This is a bit of a workaround
    ...
    struct Page_Descriptor {
        ...
        /// Creates a page descriptor, allocating a new page struct, taking ownership of the given
        /// page
     ...
     */
    Page *alloc_pages(size_t count, bool contiguous = true,
                      AllocPolicy policy = AllocPolicy::Normal) noexcept;
     ...
     */
    phys_page_t get_memory_for_kernel(size_t number_of_pages,
                                      AllocPolicy policy = AllocPolicy::Normal) noexcept;
    ...
    struct PMMRegion {
        ...
        constexpr PMMRegion(Page::page_addr_t start, u64 size_bytes) noexcept
